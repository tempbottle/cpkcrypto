...
void *x963_kdf(const EVP_MD *md, const void *share, size_t sharelen,
...
void *x963_md5kdf(const void *share, size_t sharelen,
	void *key, size_t *keylen)
{
	return x963_kdf(EVP_md5(), share, sharelen, key, *keylen);
}

void *x963_rmd160kdf(const void *share, size_t sharelen,
	void *key, size_t *keylen)
{
	return x963_kdf(EVP_ripemd160(), share, sharelen, key, *keylen);
}

void *x963_sha1kdf(const void *share, size_t sharelen,
	void *key, size_t *keylen)
{
	return x963_kdf(EVP_sha1(), share, sharelen, key, *keylen);
}

void *x963_sha224kdf(const void *share, size_t sharelen,
	void *key, size_t *keylen)
{
	return x963_kdf(EVP_sha224(), share, sharelen, key, *keylen);
}

void *x963_sha256kdf(const void *share, size_t sharelen,
	void *key, size_t *keylen)
{
	return x963_kdf(EVP_sha256(), share, sharelen, key, *keylen);
}

void *x963_sha384kdf(const void *share, size_t sharelen,
	void *key, size_t *keylen)
{
	return x963_kdf(EVP_sha384(), share, sharelen, key, *keylen);
}

void *x963_sha512kdf(const void *share, size_t sharelen,
	void *key, size_t *keylen)
{
