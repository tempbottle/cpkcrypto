...
//        }
        ...
        Digest dgst = new SHA1Digest();
        DSADigestSigner signer = new DSADigestSigner(dsa, dgst);
        
        ECPrivateKey ecPrikey = (ECPrivateKey)key;
        ECPrivateKeyParameters param = new ECPrivateKeyParameters(
        		ecPrikey.getD(),
        		new ECDomainParameters(
        				ecPrikey.getParameters().getCurve(),
        				ecPrikey.getParameters().getG(),
        				ecPrikey.getParameters().getN(),
        				ecPrikey.getParameters().getH()
        		)
        );
        signer.init(true, param);
        byte[] content = object.getEncoded(ASN1Encodable.DER);
