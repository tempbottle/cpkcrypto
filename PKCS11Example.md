...
The CPK mechanism, denoted CKM\_CPK, is a multi-purpose mechanism. It supports single-part encryption and decryption; single-part signatures and verification without message recovery. The result of encryption is a modified PKCS #7 RecipientInfo DER-encoding data. The signature is a modified PKCS #7 SignerInfo DER-encoding data.
